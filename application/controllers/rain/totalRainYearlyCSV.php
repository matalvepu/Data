...
class TotalRainYearlyCSV extends CI_Controller
{	
	public function index()
	{
             ...
             $fileName = "Yearly Rain".$stationName;
        ...
        public function avgMinMaxTempWeekly($sid,$syear,$eyear,$fileName)
        {
            ...
            for($year = $syear ; $year <= $eyear ; $year++)
            {
                ...
                $avgRain = $this->weatherDataRain->totalRainInYear($sid,$year);
                $array[] =array($year,$avgRain);
